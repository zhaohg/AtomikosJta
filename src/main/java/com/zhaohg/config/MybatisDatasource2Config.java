package com.zhaohg.config;

import com.zhaohg.util.MyMapper;
...
@MapperScan(basePackages = "com.zhaohg.mapper2", markerInterface = MyMapper.class, sqlSessionFactoryRef = "sqlSessionFactory2")
